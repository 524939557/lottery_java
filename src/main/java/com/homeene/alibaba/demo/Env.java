...
public class Env {
	...
	public static final String CORP_ID = "client_credential";
	
	public static final String CORP_SECRET = "oRIsb5QwdhKLlueYFWU6WuF1eryx26NFK09Ro4ladXEX5HXn9ZQjRr4pADKmRN1r";
